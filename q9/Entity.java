...
class Entity {
 ...
 public Entity(int id, String createdDate, String updatedDate) throws AirlineDataException {
     ...
     if (createdDate == null || createdDate.isEmpty()) throw new AirlineDataException("Created date cannot be empty");
     if (updatedDate == null || updatedDate.isEmpty()) throw new AirlineDataException("Updated date cannot be empty");
