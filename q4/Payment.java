...
public Payment(int id, String createdDate, String updatedDate, String hotelName,
   ...
   if (paymentMethod == null || paymentMethod.isEmpty()) throw new HotelDataException("Payment method cannot be empty");
   if (paymentDate == null || paymentDate.isEmpty()) throw new HotelDataException("Payment date cannot be empty");
...
public String toString() {
   return super.toString() + ", Payment Method: " + paymentMethod + ", Payment Date: " + paymentDate;
}
}